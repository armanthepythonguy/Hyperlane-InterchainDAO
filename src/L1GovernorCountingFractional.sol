 ...
 * knowledge proofs.
 */
contract L1GovernorCountingFractional is Governor, GovernorSettings, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl{
    ...
    constructor(IVotes _token, TimelockController _timelock, address _L1VoteDelegator)
        Governor("MyGovernor")
        GovernorSettings(0 /* 1 day */, 450 /* 1 week */, 0)
    ...
    function propose(address[] memory targets, uint256[] memory values, bytes[] memory calldatas, string memory description)
        ...
        returns (uint256)
    {
        IL1VoteDelegator(L1VoteDelegator).bridgeProposal(abi.encode(targets, values, calldatas, description));
