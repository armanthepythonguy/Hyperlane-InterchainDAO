...
function canonizeId(data) {
    ...
    const buf = ethers_1.ethers.utils.arrayify(data);
    if (buf.length > 32) {
    ...
    return ethers_1.ethers.utils.zeroPad(buf, 32);
}
 ...
 */
function evmId(data) {
    const u8a = ethers_1.ethers.utils.arrayify(data);
    if (u8a.length === 32) {
        return ethers_1.ethers.utils.hexlify(u8a.slice(12, 32));
    }
    else if (u8a.length === 20) {
        return ethers_1.ethers.utils.hexlify(u8a);
    }
    else {
