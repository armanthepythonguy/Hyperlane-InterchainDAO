...
export declare type DefaultIsmSetEvent = TypedEvent<[string], DefaultIsmSetEventObject>;
export declare type DefaultIsmSetEventFilter = TypedEventFilter<DefaultIsmSetEvent>;
